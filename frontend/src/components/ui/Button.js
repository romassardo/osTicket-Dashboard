...
const Button = ({ children, variant = 'primary', size = 'md', leftIcon, rightIcon, isLoading = false, className, disabled, ...props }) => {
    const baseStyles = [
    ...
    return (_jsx("button", { className: combinedClassName, disabled: disabled || isLoading, ...props, children: isLoading ? (_jsxs("svg", { className: "animate-spin h-5 w-5 text-current", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", children: [_jsx("circle", { className: "opacity-25", cx: "12", cy: "12", r: "10", stroke: "currentColor", strokeWidth: "4" }), _jsx("path", { className: "opacity-75", fill: "currentColor", d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" })] })) : (_jsxs(_Fragment, { children: [leftIcon && _jsx("span", { className: `${iconBaseStyle} ${iconLeftStyle}`, children: leftIcon }), children, rightIcon && _jsx("span", { className: `${iconBaseStyle} ${iconRightStyle}`, children: rightIcon })] })) }));
};
